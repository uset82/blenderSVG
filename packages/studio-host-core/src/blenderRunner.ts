...
import type { AvatarConfig } from "@codex-avatar-studio/avatar-core";
...
export async function findBlenderExecutable(config: AvatarConfig, outputChannel: Logger): Promise<string | null> {
...
class BoundedPrefixedLog {
  ...
  constructor(outputChannel: Logger, prefix: string, byteLimit: number) {
