...
- [x] 4.4 Pick final; export SVG (sanitized, `currentColor`), favicon 16/32, app icon 128/512, VS Code extension icon
- [x] 4.5 Clear-space, min size, colour variants, misuse rules

> Phase 4 evidence: concepts A–D, lockups on paper/ink/vermilion grounds, treatments, sizes and rules are on the Logo artboard. 4.4: SVG files are in `docs/design/brand/`, the 16 px PNG reads as a K, and `pnpm test:unit` passed 280/280.
